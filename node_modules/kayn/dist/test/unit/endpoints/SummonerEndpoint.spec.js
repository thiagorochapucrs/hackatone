...
describe('SummonerEndpoint', function () {
  ...
  describe('.by.name', function () {
    it('should have the correct payload #1', function () {
      var _Summoner$by$name = this.Summoner.by.name(_mocks2.default.summoner.Contractz.name),
          payload = _Summoner$by$name.payload;
    ...
    it('should encode the summoner name', function () {
      var _Summoner$by$name2 = this.Summoner.by.name(_mocks2.default.summoner.ShouldEncode),
          payload = _Summoner$by$name2.payload;
  ...
  describe('.by.id', function () {
    it('should have the correct payload #1', function () {
      var _Summoner$by$id = this.Summoner.by.id(_mocks2.default.summoner.Contractz.id),
          payload = _Summoner$by$id.payload;
  ...
  describe('.by.accountID', function () {
    it('should have the correct payload #1', function () {
      var _Summoner$by$accountI = this.Summoner.by.accountID(_mocks2.default.summoner.Contractz.accountId),
          payload = _Summoner$by$accountI.payload;
